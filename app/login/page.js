    ...
    return (
        <>
            {status === 'loading' ? <Loading /> :
                <>
                    <div className='text-text-col py-10'>
                        <div className=" h-[72vh] flex flex-col gap-7 items-center p-10 justify-center">
                            <h1 className='text-3xl lg:text-5xl font-extrabold text-secondary text-center'><span className='text-text-col'>Login/SignUp </span>to start funding <br /> your creator</h1>
                            <button onClick={() => signIn("google")}
                                className="flex items-center justify-center bg-auth-col border border-primary-dark rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-text-col hover:bg-primary-dark w-full">
                            ...
                            <button onClick={() => signIn("github")}
                                className="bg-auth-col flex items-center justify-center w-full border border-primary-dark rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-text-col hover:bg-primary-dark ">
                                <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
